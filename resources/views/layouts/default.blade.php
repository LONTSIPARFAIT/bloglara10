    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <header class="flex justify-between items-center space-x-5 text-slate-900">
            ...
            <form action="{{ route('index') }}"
                class="pb-3 pr-2 flex items-center border-b border-b-slate-300 text-slate-300 focus-within:border-b-slate-900 focuswithin:text-slate-900 transition">
            ...
            <nav x-data="{ open: false }" x-cloak class="relative">
                ...
                <ul x-show="open" x-transition:enter="transition ease-out duration-200"
                    ...
                    @auth
                      <li><a href="{{ route('home') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Mon compte</a>
                      </li>

                      @if (Auth::user()->isAdmin())
                      <li><a href="{{ route('admin.posts.index') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Gestion des posts</a>
                      </li>

                      @endif

                      <li><a @click.prevent="$refs.logout.submit()" href="{{ route('logout')}}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Deconnexion</a>
                      </li>
                    ...
                    @else
                      ...
                      <li><a href="{{ route('login') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Connexion</a>
                      </li>
                      <li>
